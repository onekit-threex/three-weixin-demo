...
Page({
    ...
    createMesh() {
        ...
        var mesh = new THREE.Mesh(new THREE.EdgesGeometry(
            sphereGeometry, 
            this.setting.thresholdAngle,
        ), material);
    ...
    async run(canvas) {
        ...
        function createPanel() {
            ...
            folder2.add({
                name: "thresholdAngle",
                thresholdAngle: that.setting.thresholdAngle
            }, 'thresholdAngle', 0.0, 10, 0.01).onChange((value) => {
                that.setting.thresholdAngle = value;
                that.createMesh();
            });
            //
            folder3.add({
